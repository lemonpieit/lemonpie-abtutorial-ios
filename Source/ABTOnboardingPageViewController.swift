...
internal final class ABTOnboardingPageViewController: UIViewController {
    ...
    private func configureViews() {
        ...
        [pageStackView.topAnchor.constraint(equalTo: actionButton.bottomAnchor, constant: 16),
         pageStackView.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 0),
         pageStackView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -16),
         pageStackView.rightAnchor.constraint(equalTo: view.rightAnchor, constant: 0)].forEach { $0.isActive = true }
        ...
        [animationView.leftAnchor.constraint(equalTo: pageStackView.leftAnchor, constant: 0),
         animationView.rightAnchor.constraint(equalTo: pageStackView.rightAnchor, constant: 0)].forEach { $0.isActive = true }
